...
//           <select className="input" name="departure" onChange={selectDeparture}>
...
//         <select className="input" name="destination" onChange={selectDestination}>
...
//       <div className="flight-cards">{departure} to {destination}
//       {flights.map (
